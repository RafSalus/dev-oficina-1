...
export function ManagementAuthLayout({ children }) {
  return (
    <div className="min-h-dvh flex bg-white text-black">
      {/* Left branding banner (Desktop) */}
      <div className="relative hidden lg:flex lg:w-1/2 bg-black flex-col justify-between p-12 overflow-hidden">
        <picture>
          <source srcSet="/images/Tela-CEO.webp" type="image/webp" />
          <img
            src="/images/Tela-CEO.png"
            alt=""
        ...
        <div className="relative z-10 max-w-lg mb-8">
          ...
          <h2 className="text-4xl font-bold text-white mb-4 leading-tight">Painel de Gestão</h2>
          <p className="text-gray-300 text-lg">
            Acesso exclusivo para a equipe administrativa da oficina.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col min-h-dvh bg-white">
        ...
        <div className="lg:hidden py-6 px-6 text-center text-xs text-gray-500 whitespace-nowrap overflow-hidden text-ellipsis">
          © 2026 {COMPANY.name}. Todos os direitos reservados.
        </div>
      </div>
    </div>
