...
const QUICK_ACTIONS = [
  { id: 'nova-os', label: 'Nova OS', path: '/secretaria/ordem-de-servico', icon: Plus },
  ...
  { id: 'veiculos', label: 'Veículos', path: '/secretaria/veiculos', icon: CarProfile },
  { id: 'pdv', label: 'PDV', path: '/secretaria/pdv', icon: CreditCard },
  { id: 'estoque', label: 'Estoque', path: '/secretaria/estoque', icon: Package },
  { id: 'leva-e-traz', label: 'Leva e Traz', path: '/secretaria/leva-e-traz', icon: ArrowsLeftRight },
  { id: 'configuracoes', label: 'Ajustes', path: '/secretaria/configuracoes', icon: GearSix },
]
...
export function MobileSecretariaHomeScreen() {
