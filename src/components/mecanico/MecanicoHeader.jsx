...
export function MecanicoHeader({ isPinned = false, onTogglePin }) {
  ...
  const handleLogout = () => {
    ...
    toast.info('Sessão do mecânico encerrada com sucesso.')
  ...
  return (
    <>
      ...
      >
        {/* Lado Esquerdo: Logo, Nome da Oficina e Portal do Mecânico */}
        ...
        {/* Lado Direito: Fixar, Notificações, Perfil do Mecânico e Botão Sair */}
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={notifRef}>
            <button
              ...
              title="Avisos de peças e ordens de serviço"
            >
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white border border-[#d0d5dd] rounded-2xl shadow-xl z-50 overflow-hidden text-xs animate-in fade-in zoom-in-95 duration-150">
                <div className="p-3.5 bg-[#f8fafc] border-b border-[#e4e7ec] flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="font-extrabold text-[#101828]">Notificações da Oficina</span>
          ...
          {/* Área Individual do Mecânico: Nome, Perfil e Logout */}
          <div className="relative" ref={profileRef}>
            ...
            {showProfile && (
              <div className="absolute right-0 mt-2 w-64 bg-white border border-[#d0d5dd] rounded-2xl shadow-xl z-50 p-2 text-xs animate-in fade-in zoom-in-95 duration-150">
                {/* Identificação do Mecânico */}
                <div className="p-3 bg-[#f8fafc] rounded-xl border border-[#e4e7ec] mb-1.5">
                  ...
                  <span className="text-[11px] text-[#475467] block mt-0.5 truncate">
                    {mecanicoAtivo.email || `${mecanicoAtivo.value}@mecanicagabriel.com.br`}
                  </span>
                </div>
      ...
      {/* Modal de Perfil Detalhado do Mecânico */}
      {showProfileModal && (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#667085] font-semibold mt-0.5">
                    {mecanicoAtivo.cargo || 'Mecânico da Oficina'}
                  </p>
              ...
              <div className="bg-[#f8fafc] border border-[#e4e7ec] rounded-xl divide-y divide-[#e4e7ec] text-xs">
                <div className="p-3 flex items-center justify-between">
                  <span className="text-[#667085] font-medium flex items-center gap-2">
                    <Wrench size={15} className="text-[#0284c7]" /> Especialidade
                  </span>
                  <span className="font-bold text-[#101828] text-right">
                    {mecanicoAtivo.especialidade || 'Mecânica Geral'}
                  </span>
                </div>
                ...
                <div className="p-3 flex items-center justify-between">
                  <span className="text-[#667085] font-medium flex items-center gap-2">
                    <Clock size={15} className="text-[#0284c7]" /> Horário
                  </span>
